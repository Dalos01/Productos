Algoritmo Producto
	...
	Mientras produc=1 Hacer
		...
		escribir "Digite el código del producto que desea llevar, por favor"
		leer l
		
		escribir "El valor de este producto elegido es: ",val_prod[l]
		acu<-acu+val_prod[l]
		c<-c+1
	...
	valcomfi<-impuesto ( acu )+des (acu)
	escribir "El valor total con impuestos incluidos es de: ", valcomfi
FinAlgoritmo
